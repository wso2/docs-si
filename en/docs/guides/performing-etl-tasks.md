...
![Performing ETL in Real Time]({{base_path}}/images/performing-etl-operations/performing-etl-in-real-time.png)
...
![Adding a new source]({{base_path}}/images/performing-etl-operations/adding-a-new-source.png)
...
WSO2 Integrator: SI for VS Code provides a Source View and a Graphical View for designing Siddhi applications. For more information, see [WSO2 Integrator: SI for VS Code Overview](../develop/si-for-vscode-overview.md).
