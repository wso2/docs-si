...
WSO2 Integrator: SI provides the Source View, Design View and the Wizard View for application design. For more information, see [WSO2 Integrator: SI Tooling Overview](../develop/streaming-integrator-studio-overview.md).
