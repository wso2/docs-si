...
The WSO2 Integrator: SI can consume from a Kafka topic as well as publish to a Kafka topic in a streaming manner.
...
Navigate to the `<SI_HOME>/bin` directory and issue the appropriate command based on your operating system:
