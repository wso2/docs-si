...
## Downloading the WSO2 Integrator: SI runtime and tooling
...
- To download WSO2 Integrator: SI Tooling, click **Tooling** in the [WSO2 Integrator: SI Product Page](https://wso2.com/integration/streaming-integrator/). Enter you email address and agree to the license. Then click **MacOS Installer pkg** download the WSO2 Integrator: SI as a zip file.
...
- Design, test and deploy Siddhi applications via WSO2 Integrator: SI Tooling.
