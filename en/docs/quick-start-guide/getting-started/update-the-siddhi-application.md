...
1. Start and access WSO2 Integrator: SI Tooling. Click the **File Explorer** icon in the side panel and then click **SweetFactoryApp.siddhi** to open the Siddhi application that you already created and saved.
...
!!! tip "What's Next?"
    Next, you can configure WSO2 Integrator: SI to handle errors that can occur in the Streaming Integration flow of the `SweetFactoryApp` Siddhi application. To do this, proceed to [Step 7: Handle Errors](handle-errors.md).