...
2. In the Streaming Integrator Tooling, click **Deploy** and then click **Deploy to Server**.
    ...
    ![Deploy Siddhi Apps to Server]({{base_path}}/images/quick-start-guide-101/deploy-to-server-dialog-box.png)
...
3. In the **Add New Server** section, enter information as follows:
    ...
    ![Add Server]({{base_path}}/images/quick-start-guide-101/add-server.png)

    Then click **Add**.

4. Select the check boxes for the **SweetFactoryApp.siddhi** Siddhi application and the server you added as shown below.

    ![Deploy Siddhi Apps to Server]({{base_path}}/images/quick-start-guide-101/select-siddhi-app-and-server.png)
...
5. Click **Deploy**.
    ...
    ![Siddhi App successfully deployed]({{base_path}}/images/quick-start-guide-101/siddhi-app-successfully-deployed.png)
...
2. Click **Export** in the top menu, and then click **For Docker**.
    ...
    ![Export as Docker dialog box]({{base_path}}/images/quick-start-guide-101/export-as-docker-dialog-box.png)
...
4. In **Step 2**, you can template values of the Siddhi Application.
    ...
    ![Template Siddhi Apps dialog box]({{base_path}}/images/quick-start-guide-101/template-siddhi-apps-dialog-box.png)
...
6. In **Step 4**, you can provide arguments for the values that were templated in **Step 2**.
    ...
    ![Populate Arguments Template dialog box]({{base_path}}/images/quick-start-guide-101/populate-arguments-template-dialog-box.png)
...
7. In **Step 5**, you can choose additional dependencies to be bundled. This is applicable when Sources, Sinks and etc. with additional dependencies are used in the Siddhi Application (e.g., a Kafka Source/Sink, or a MongoDB Store).
    ...
    ![Bundle Additional Dependencies dialog box]({{base_path}}/images/quick-start-guide-101/bundle-additional-dependencies-dialog-box.png)
