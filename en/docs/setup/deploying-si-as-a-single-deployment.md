...
[Scalable High Availability (HA) Deployment](deploying-si-as-a-scalable-cluster.md) are mainly introduced to handle high availability, scalability, and resiliency.
...
losing any data. WSO2 Integrator: SI has the capability to achieve the above via a broker that can replay data from a
