# Upgrade WSO2 Integrator

This document walks you through the process of upgrading WSO2 Integrator: SI.
...
Over the course of its lifetime, WSO2 Integrator: SI has changed significantly and some of the features you were using in an older version may not work the same way.

## Get started

To make sure that the upgrade process is smooth and you have the best experience, WSO2 recommends that you reach out to WSO2 Support to upgrade WSO2 Integrator: SI with minimal difficulty.
