...
## Purpose
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via HTTP transport in JSON default format, Receive response from the http server and process the response using siddhi.
...
## Testing the Sample
1. Open a terminal and navigate to <SI_HOME>/samples/sample-clients/http-server and run "ant" command without any arguments.
