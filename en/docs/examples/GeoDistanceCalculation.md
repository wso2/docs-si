...
!!!info "Before you begin:"
    1. Download the [siddhi-gpl-execution-geo-x.x.x.jar](https://maven.wso2.org/nexus/content/repositories/wso2gpl/org/wso2/extension/siddhi/gpl/execution/geo/siddhi-gpl-execution-geo/5.0.0/siddhi-gpl-execution-geo-5.0.0.jar) and place it in the `<SI_HOME>/lib` directory.<br/>
    2. Save this sample in WSO2 Integrator: SI.
...
The following output is logged in the WSO2 Integrator: SI console for the single event you simulated.
