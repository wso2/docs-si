...
[Performing Real-time Change Data Capture with MySQL] tutorial covers how to perform change data capture in details. Therefore, in this tutorial, let's learn how WSO2 Integrator: SI can incorporate data stores in streaming operations by performing CRUD operations.
...
!!! tip  "Before you begin:"
    ...
    - Install the `rdbms-mysql` extension in WSO2 Integrator: SI as follows.<br/><br/>
        1. Start WSO2 Integrator: SI Tooling by navigating to the `<SI_TOOLING_HOME>/bin` directory and issuing the appropriate command based on your operating system.<br/><br/>
            - **For Linux**  : `./tooling.sh`
            - **For Windows**: `tooling.bat --run`<br/><br/>
        2. Access WSO2 Integrator: SI Tooling. Then click **Tools** -> **Extension Installer** to open the **Extension Installer** dialog box.<br/><br/>
        ...
        4. Restart WSO2 Integrator: SI Tooling.<br/><br/>
...
4. Simulate events as follows:
    ...
    3. Execute the following MySQL queries:
        ...
        ![Saved Stock Records]({{base_path}}/images/integrating-stores/saved-stock-records.png)
...
!!! tip "Before you begin:"
    To allow WSO2 Integrator: SI Tooling to perform CRUD operations, open `<SI_TOOLING_HOME>/conf/server/deployment.yaml` file, and add an extract as shown below with the `perform.CRUD.operations` parameter set to `true` as shown below:<br/><br/>
        ```yaml
        siddhi:
          extensions:
            -
