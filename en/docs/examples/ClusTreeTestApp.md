...
!!!info "Before you begin:"
    1. Download `siddhi-gpl-execution-streamingml-x.x.x.jar` from [here](https://maven.wso2.org/nexus/content/repositories/wso2gpl/org/wso2/extension/siddhi/gpl/execution/streamingml/siddhi-gpl-execution-streamingml/) and place it in the `<SI_HOME>/lib` directory.<br/>
    ...
    4. Save the sample Siddhi application in WSO2 Integrator: SI.<br/>
...
To test the sample Siddhi application, simulate multiple events via CSV file in the WSO2 Integrator: SI as follows:
