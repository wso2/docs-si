# Publishing Consumed Events to Prometheus Metrics and Exposing them via HTTP
...
1. The following steps must be executed to enable WSO2 SP to publish events to Prometheus
    ...
    3. Download and copy the prometheus client jars to the <SI_HOME>/lib directory as follows.
        1. Download the following jars from https://mvnrepository.com/artifact/io.prometheus and copy them to <SI_HOME>/lib directory.
