...
## Prerequisites
1. Download siddhi-gpl-execution-nlp-x.x.x.jar from the following link and copy the jar to  <SI_HOME>/lib
https://maven.wso2.org/nexus/content/repositories/wso2gpl/org/wso2/extension/siddhi/gpl/execution/nlp/siddhi-gpl-execution-nlp/
