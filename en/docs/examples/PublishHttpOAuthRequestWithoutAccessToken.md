# Publishing HTTP Events to an OAuth-protected Endpoint without an Access Token

## Purpose

This application demonstrates how to configure WSO2 Integrator: SI to send HTTP events to an OAuth-protected endpoint without an access token.
