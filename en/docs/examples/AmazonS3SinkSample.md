...
1. In WSO2 Integrator: SI, click Open and then click **AmazonS3SinkSample.siddhi** in the **workspace** directory. Then update it as follows:
...
2. Start the Siddhi application by clicking the **Start** button (shown below) or by clicking **Run** > **Run**.
...
To test the sample Siddhi application, simulate random events for it via the WSO2 Integrator: SI as follows:
