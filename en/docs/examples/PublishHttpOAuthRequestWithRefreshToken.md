...
This application demonstrates how to configure WSO2 Integrator: SI to send HTTP events to an OAuth-protected endpoint. Here we use refresh token grant type.
...
1. Stop this Siddhi application (Click 'Run' on the menu bar -> 'Stop').
2. Recheck all the parameters you are passing and correct any invalid parameter values.
