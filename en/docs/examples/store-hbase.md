...
2. Add HBase client into `<SI_HOME>/lib` as follows:
    1. Download the following jars:
        * HBase client (https://repo1.maven.org/maven2/org/apache/hbase/hbase-shaded-client/1.3.1/hbase-shaded-client-1.3.1.jar)
        * Apache HTrace core (https://repo1.maven.org/maven2/org/apache/htrace/htrace-core/3.1.0-incubating/htrace-core-3.1.0-incubating.jar)
