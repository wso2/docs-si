...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via Kafka transport in Avro format with custom mapping.
...
See the output on the terminal of `<SI_HOME>/samples/sample-clients/kafka-avro-consumer`:
