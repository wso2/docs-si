...
!!!info "Before you begin:"
    Save the sample Siddhi application in WSO2 Integrator: SI.
...
Navigate to the `<SI_HOME>/samples/sample-clients/http-client` directory and run the following command.

`ant -Dtype=json -DfilePath=<SI_HOME>/samples/artifacts/ExtremaBottomK/ExtremaBottomKEvents.txt -DeventDefinition='{"event":{"name":"{0}","amount":{1}}}' -Durl=http://localhost:8006/productionStream`

## Viewing the Results

The output is logged in the WSO2 Integrator: SI console as follows.
