...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via TCP transport in text format, and view the output in your TCP server's console.
...
4. Your TCP server receives the text-encoded events. Sample output (formatting depends on your server implementation):
