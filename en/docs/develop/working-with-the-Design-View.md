...
3.  Click **Design View** to open the Design View.  
    ...
    application.  
    ![Design View]({{base_path}}/images/working-with-the design-view/Design_View.png)
...
![Dragging and dropping Siddhi components]({{base_path}}/working-with-the design-view/Drag-And-Drop-Siddhi-Component.gif)
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Stream_Icon.png" /></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               ...
               <p><img src="{{base_path}}/working-with-the design-view/Generate-Stream.png"/></p>
               <p>The <strong>Generate Stream</strong> form opens as follows</p>
               <p><img src="{{base_path}}/working-with-the design-view/generate-stream-form.png"/></p>
               <p>To generate the stream from a file:
                ...
                <li><p>Then click <strong>Choose File</strong> and browse for the file from which you want to generate the stream. <br/> the supported file types are <code>CSV</code>, <code>JSON</code>, and <code>XML</code>. If you select a file that is not of one of these types, the <strong>Select File Type</strong> field is enabled as shown in the example below.</p>
                    <p><img src="{{base_path}}/working-with-the design-view/select-file-type.png"/></p>
                ...
                <ol>
                    ...
                    <li> Enter details relating to the data source as follows.</li>
                        <ul>
                            ...
                            <p><img src="{{base_path}}/working-with-the design-view/generate-stream-with-inline-datasource-configuration.png"/></p>
                                <ul>
                            ...
                            <p><img src="{{base_path}}/working-with-the design-view/generate-stream-with-externally-defined-datasource.png"/></p>
                                <ul>
                                    <li><strong>Stream Name</strong>: A name for the stream that you are generating.</li>
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Stream_Configuration.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Source_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Source-Configuration.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Sink_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Sink_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Table_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Table_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Window_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Window_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Trigger_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><br /></p>
               <img src="{{base_path}}/working-with-the design-view/Trigger_Configuration_Form.png"/>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Aggregation_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Aggregation_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Function_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Function_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Projection_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Projection_QueryConfiguration_Form.png"/></p>
...
<p><img src="{{base_path}}/working-with-the design-view/Filter_Query_Icon.png"/></p>
</div></td>
</tr>
<tr class="even">
<td>Description</td>
...
<td>Example</td>
<td><div class="content-wrapper">
<p><img src="{{base_path}}/working-with-the design-view/Filter_Query_Configuration_Form.png"/></p>
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Window_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
...
<table>
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Join_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               ...
               <p><strong><img src="{{base_path}}/working-with-the design-view/Join_Query_Configuration_Form.png" /><br />
...
<table style="width:100%;">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Pattern_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Pattern_Query_Configuration.png"/></p>
...
<table style="width:100%;">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Sequence_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Sequence_Query_Configuration.png"/></p>
               <p>The above configuration results in creating the following query.</p>
               <div class="code panel pdl" style="border-width: 1px;">
                  <div class="codeContent panelContent pdl">
                     <div class="sourceCode" id="cb1" data-syntaxhighlighter-params="brush: sql; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: sql; gutter: false; theme: Confluence">
...
<table style="width:100%;">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Partition_Query_Icon.png"/></p>
            </div>
         </td>
      </tr>
      <tr class="even">
      ...
      <tr class="even">
         ...
         <td>
            <div class="content-wrapper">
               <p><img src="{{base_path}}/working-with-the design-view/Partition_Configuration.png"/></p>
...
![Connecting Siddhi components]({{base_path}}/working-with-the design-view/Connect-Siddhi-Components.gif)
