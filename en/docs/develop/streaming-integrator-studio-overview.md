...
![Streaming Integrator Tooling Welcome Page]({{base_path}}/images/streaming-integrator-studio-overview/streaming-integrator-tooling-welcome-page.png)
...
![File menu]({{base_path}}/images/streaming-integrator-studio-overview/FileMenu.png)
...
-   **Open File** 
    ...
    ![The source view of a Siddhi application]({{base_path}}/images/streaming-integrator-studio-overview/Siddhi-App-Source-View.png)  
    ...
    **Design View**. As a result, a graphical view of the Siddhi application is displayed as shown in the following 
    example.  
    ![The design view of Siddhi application]({{base_path}}/images/streaming-integrator-studio-overview/Siddhi-App-Design-View.png)
...
![Edit menu]({{base_path}}/images/streaming-integrator-studio-overview/Editor_Menu.png)
...
![Run menu]({{base_path}}/images/streaming-integrator-studio-overview/Run_Menu_Option.png)
...
![Tools menu]({{base_path}}/images/streaming-integrator-studio-overview/Tools_Menu.png)
...
- **Error Store Explorer**
    ...
    ![Connect to Server]({{base_path}}/images/streaming-integrator-studio-overview/connect-error-store-explorer.png)
    ...
    ![Error Store Explorer]({{base_path}}/images/streaming-integrator-studio-overview/view-basic-error-info.png)
    ...
    - **View details**: To view details of a specific error, click **Detailed Info** for the relevant event. Then the details of the error are displayed in the **Error Entry** dialog box as shown in the example below.
           ![Error Entry]({{base_path}}/images/handling-requests-with-errors/error-entry.png)
    ...
    To understand how to save messages with errors in the error store, see [Handling Errors]({{base_path}}/guides/handling-errors.md).
...
- **Sample Event Generator**
    ...
    ![Sample event generator]({{base_path}}/images/streaming-integrator-studio-overview/Sample_Event_Generator.png)  
...
- **On-Demand Query**
    ...
    ![Siddhi Store Query]({{base_path}}/images/streaming-integrator-studio-overview/on-demand-query.png)
...
Streaming Integrator servers. For more information, see [Deploying Siddhi Applications](deploying-Streaming-Applications.md).

![Deploy menu]({{base_path}}/images/streaming-integrator-studio-overview/Deploy_Menu.png)
...
![Export menu]({{base_path}}/images/streaming-integrator-studio-overview/Export_Menu.png)

- **For Docker**
    This opens the **Export Siddhi Apps for Docker image** wizard. For more information, see [Exporting Siddhi Applications - Exporting Siddhi applications as a Docker Image](exporting-Siddhi-Applications.md#exporting-siddhi-applications-as-a-docker-image).

- **For Kubernetes**
    This opens the **Export Siddhi Apps For Kubernetes CRD** wizard. For more information, see [Exporting Siddhi Applications - Exporting Siddhi Applications for Kubernetes](exporting-Siddhi-Applications.md#exporting-siddhi-applications-for-kubernetes).

## Side Panel

**File Explorer**

![File Explorer menu]({{base_path}}/images/streaming-integrator-studio-overview/File Explorer.png)

This provides a view of all the files saved as shown in the example above.

### Event Simulator

![Event Simulator]({{base_path}}/images/streaming-integrator-studio-overview/Event_Simulator.png)
...
![Output Console]({{base_path}}/images/streaming-integrator-studio-overview/outputConsole.png)

This provides feedback on various user activities carried out on the Streaming Integrator.

### Operator Finder

![Operator Finder]({{base_path}}/images/streaming-integrator-studio-overview/Operator_Finder.png)
...
### Template Variables
 ...
 ![Template Variables]({{base_path}}/images/streaming-integrator-studio-overview/template_variables-icon.png)
...
Click this icon to open the **Templated Variables** side panel (shown below) where you can open the templated attributes in the currently saved Siddhi applications and provide variables to be applied when running the Siddhi applications.
 ...
 ![Templated Variables]({{base_path}}/images/streaming-integrator-studio-overview/templated-variables.png)
...
## Toolbar
  ...
  ![Tool Bar menu]({{base_path}}/images/streaming-integrator-studio-overview/Editor_Toolbar.png)
