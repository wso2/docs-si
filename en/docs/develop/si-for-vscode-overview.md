...
| **Step 5: Running Siddhi Applications**        | Once deployed, the Siddhi application runs in the SI server. For hands-on practice with end-to-end scenarios, see the [WSO2 Integrator: SI Tutorials](../examples/tutorials-overview.md).                                                                                                                                                                                                          |
