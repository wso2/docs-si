...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via MQTT transport in XML format and view the output on the mqtt-consumer.
