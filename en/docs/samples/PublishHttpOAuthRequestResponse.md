...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to sending an HTTP event via an OAuth protected endpoint and catching its response.
