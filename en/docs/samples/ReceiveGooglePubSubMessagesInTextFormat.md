...
## Purpose:
This application demonstrates how to configure WSO2 Integrator: SI using googlepubsub source in Siddhi to consume events. Events which are in TEXT format are consumed from a googlepubsub topic.
