...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to receive events via HTTP transport and view the output on the console. The count of all events arriving to the stream is calculated.
