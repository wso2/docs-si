...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to send sweet production events via TCP transport in JSON format, and view the output in the console.
