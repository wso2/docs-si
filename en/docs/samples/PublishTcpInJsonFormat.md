...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via TCP transport in JSON format, and view the output in the console.

## Executing the sample

1. Open a terminal and navigate to the `<SI_HOME>/samples/sample-clients/tcp-server` directory and run the following command:
