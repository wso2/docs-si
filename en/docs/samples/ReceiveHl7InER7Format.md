...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to receive Hl7 events in ER7 format to the `hl7Stream` via MLLP protocol and log the events in er7Stream to the output console.
