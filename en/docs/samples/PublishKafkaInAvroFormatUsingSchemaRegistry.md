...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via the Kafka transport in Avro format using Confluent Schema Registry.

## Prerequisites

1. To install Kafka, follow the steps below

    1. In WSO2 Integrator: SI, click **Tools**, and then click **Extension Installer**.
...
1. In WSO2 Integrator: SI, open the Event Simulator by clicking on the **Event Simulator** icon in the left panel or pressing Ctrl+Shift+I.
