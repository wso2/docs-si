...
This application demonstrates how to configure WSO2 Integrator: SI to send sweet production events via TCP transport in text format, and view the output on the server terminal.
