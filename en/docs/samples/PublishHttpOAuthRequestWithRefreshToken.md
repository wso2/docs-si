...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to send HTTP events to an OAuth-protected endpoint. Here we use refresh token grant type.
