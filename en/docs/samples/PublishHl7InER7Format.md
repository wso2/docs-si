...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to send Hl7 events in ER7 format via MLLP protocol and log the events in `hl7Stream` and the acknowledgement message to the output console.
