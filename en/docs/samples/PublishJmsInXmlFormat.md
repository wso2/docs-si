...
This application demonstrates how to configure the WSO2 Integrator: SI VSCode extension to send sweet production events via JMS transport in Xml format.
