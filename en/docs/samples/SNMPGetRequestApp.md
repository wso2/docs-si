...
## Purpose:
This application demonstrates how to configure WSO2 Integrator: SI to receive events from an SNMP source via SNMP in key-value format using custom mapping.
