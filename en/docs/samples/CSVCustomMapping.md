...
This application demonstrates how to configure WSO2 Integrator: SI to publish and receive data events processed within Siddhi to files in CSV custom format.
