...
material/base.html
```
# Customizations done to the top navigation tabs-item.html for navigation separation

Top navigation separation is achieved through matching the titles of pages which are on the right.
If titles need to be changed in right-floated nav links, tabs-item.html has to be changed as well.
